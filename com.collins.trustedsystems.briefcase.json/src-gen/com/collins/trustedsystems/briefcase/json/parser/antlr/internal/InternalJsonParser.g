...
ruleAnnexLibrary returns [EObject current=null] 
    ...
    {
        $current = $this_JsonAnnexLibrary_0.current;
...
entryRuleJsonAnnexLibrary returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getJsonAnnexLibraryRule()); }
	 iv_ruleJsonAnnexLibrary=ruleJsonAnnexLibrary 
	 { $current=$iv_ruleJsonAnnexLibrary.current; } 
	 EOF 
;

// Rule JsonAnnexLibrary
ruleJsonAnnexLibrary returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
entryRuleJsonAnnexSubclause returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getJsonAnnexSubclauseRule()); }
	 iv_ruleJsonAnnexSubclause=ruleJsonAnnexSubclause 
	 { $current=$iv_ruleJsonAnnexSubclause.current; } 
	 EOF 
;

// Rule JsonAnnexSubclause
ruleJsonAnnexSubclause returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
entryRuleJsonAnnexElement returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getJsonAnnexElementRule()); }
	 iv_ruleJsonAnnexElement=ruleJsonAnnexElement 
	 { $current=$iv_ruleJsonAnnexElement.current; } 
	 EOF 
;

// Rule JsonAnnexElement
ruleJsonAnnexElement returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
    ...
    {
        $current = $this_JsonAnnexObject_0.current;
        afterParserOrEnumRuleCall();
    }
    ...
    {
        $current = $this_JsonAnnexArray_1.current;
        afterParserOrEnumRuleCall();
    }
    ...
    {
        $current = $this_JsonAnnexString_2.current;
        afterParserOrEnumRuleCall();
    }
    ...
    {
        $current = $this_JsonAnnexNumber_3.current;
        afterParserOrEnumRuleCall();
    }
    ...
    {
        $current = $this_JsonAnnexBoolean_4.current;
        afterParserOrEnumRuleCall();
    }
    ...
    {
        $current = $this_JsonAnnexNull_5.current;
        afterParserOrEnumRuleCall();
    }
)
;
...
entryRuleJsonAnnexObject returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getJsonAnnexObjectRule()); }
	 iv_ruleJsonAnnexObject=ruleJsonAnnexObject 
	 { $current=$iv_ruleJsonAnnexObject.current; } 
	 EOF 
;

// Rule JsonAnnexObject
ruleJsonAnnexObject returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
entryRuleJsonAnnexArray returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getJsonAnnexArrayRule()); }
	 iv_ruleJsonAnnexArray=ruleJsonAnnexArray 
	 { $current=$iv_ruleJsonAnnexArray.current; } 
	 EOF 
;

// Rule JsonAnnexArray
ruleJsonAnnexArray returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
entryRuleJsonAnnexMember returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getJsonAnnexMemberRule()); }
	 iv_ruleJsonAnnexMember=ruleJsonAnnexMember 
	 { $current=$iv_ruleJsonAnnexMember.current; } 
	 EOF 
;

// Rule JsonAnnexMember
ruleJsonAnnexMember returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
entryRuleJsonAnnexString returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getJsonAnnexStringRule()); }
	 iv_ruleJsonAnnexString=ruleJsonAnnexString 
	 { $current=$iv_ruleJsonAnnexString.current; } 
	 EOF 
;

// Rule JsonAnnexString
ruleJsonAnnexString returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
entryRuleJsonAnnexNumber returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getJsonAnnexNumberRule()); }
	 iv_ruleJsonAnnexNumber=ruleJsonAnnexNumber 
	 { $current=$iv_ruleJsonAnnexNumber.current; } 
	 EOF 
;

// Rule JsonAnnexNumber
ruleJsonAnnexNumber returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(((
...
ruleSignedInteger returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] 
    ...
    this_INT_NUMBER_0=RULE_INT_NUMBER    {
...
ruleSignedReal returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] 
    ...
    this_REAL_NUMBER_0=RULE_REAL_NUMBER    {
...
entryRuleJsonAnnexBoolean returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getJsonAnnexBooleanRule()); }
	 iv_ruleJsonAnnexBoolean=ruleJsonAnnexBoolean 
	 { $current=$iv_ruleJsonAnnexBoolean.current; } 
	 EOF 
;

// Rule JsonAnnexBoolean
ruleJsonAnnexBoolean returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(((
...
entryRuleJsonAnnexNull returns [EObject current=null]
	:
	{ newCompositeNode(grammarAccess.getJsonAnnexNullRule()); }
	 iv_ruleJsonAnnexNull=ruleJsonAnnexNull 
	 { $current=$iv_ruleJsonAnnexNull.current; } 
	 EOF 
;

// Rule JsonAnnexNull
ruleJsonAnnexNull returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
