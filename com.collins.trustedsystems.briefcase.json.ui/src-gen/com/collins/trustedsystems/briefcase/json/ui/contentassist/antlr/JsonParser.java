 ...
 * generated by Xtext
 */
package com.collins.trustedsystems.briefcase.json.ui.contentassist.antlr;
...
public class JsonParser extends AbstractPartialContentAssistParser {
	...
	@Override
	protected com.collins.trustedsystems.briefcase.json.ui.contentassist.antlr.internal.InternalJsonParser createParser() {
		com.collins.trustedsystems.briefcase.json.ui.contentassist.antlr.internal.InternalJsonParser result = new com.collins.trustedsystems.briefcase.json.ui.contentassist.antlr.internal.InternalJsonParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getJsonAnnexElementAccess().getAlternatives(), "rule__JsonAnnexElement__Alternatives");
					put(grammarAccess.getJsonAnnexNumberAccess().getAlternatives(), "rule__JsonAnnexNumber__Alternatives");
					put(grammarAccess.getJsonAnnexBooleanAccess().getAlternatives(), "rule__JsonAnnexBoolean__Alternatives");
					...
					put(grammarAccess.getJsonAnnexLibraryAccess().getGroup(), "rule__JsonAnnexLibrary__Group__0");
					put(grammarAccess.getJsonAnnexSubclauseAccess().getGroup(), "rule__JsonAnnexSubclause__Group__0");
					put(grammarAccess.getJsonAnnexObjectAccess().getGroup(), "rule__JsonAnnexObject__Group__0");
					put(grammarAccess.getJsonAnnexObjectAccess().getGroup_2(), "rule__JsonAnnexObject__Group_2__0");
					put(grammarAccess.getJsonAnnexObjectAccess().getGroup_2_1(), "rule__JsonAnnexObject__Group_2_1__0");
					put(grammarAccess.getJsonAnnexArrayAccess().getGroup(), "rule__JsonAnnexArray__Group__0");
					put(grammarAccess.getJsonAnnexArrayAccess().getGroup_3(), "rule__JsonAnnexArray__Group_3__0");
					put(grammarAccess.getJsonAnnexMemberAccess().getGroup(), "rule__JsonAnnexMember__Group__0");
					put(grammarAccess.getJsonAnnexStringAccess().getGroup(), "rule__JsonAnnexString__Group__0");
					put(grammarAccess.getJsonAnnexNumberAccess().getGroup_0(), "rule__JsonAnnexNumber__Group_0__0");
					put(grammarAccess.getJsonAnnexNumberAccess().getGroup_1(), "rule__JsonAnnexNumber__Group_1__0");
					put(grammarAccess.getJsonAnnexBooleanAccess().getGroup_0(), "rule__JsonAnnexBoolean__Group_0__0");
					put(grammarAccess.getJsonAnnexBooleanAccess().getGroup_1(), "rule__JsonAnnexBoolean__Group_1__0");
					put(grammarAccess.getJsonAnnexNullAccess().getGroup(), "rule__JsonAnnexNull__Group__0");
					...
					put(grammarAccess.getJsonAnnexLibraryAccess().getJsonAnnexElementAssignment_1(), "rule__JsonAnnexLibrary__JsonAnnexElementAssignment_1");
					put(grammarAccess.getJsonAnnexSubclauseAccess().getJsonAnnexElementAssignment_1(), "rule__JsonAnnexSubclause__JsonAnnexElementAssignment_1");
					put(grammarAccess.getJsonAnnexObjectAccess().getJsonAnnexMembersAssignment_2_0(), "rule__JsonAnnexObject__JsonAnnexMembersAssignment_2_0");
					put(grammarAccess.getJsonAnnexObjectAccess().getJsonAnnexMembersAssignment_2_1_1(), "rule__JsonAnnexObject__JsonAnnexMembersAssignment_2_1_1");
					put(grammarAccess.getJsonAnnexArrayAccess().getJsonAnnexElementsAssignment_2(), "rule__JsonAnnexArray__JsonAnnexElementsAssignment_2");
					put(grammarAccess.getJsonAnnexArrayAccess().getJsonAnnexElementsAssignment_3_1(), "rule__JsonAnnexArray__JsonAnnexElementsAssignment_3_1");
					put(grammarAccess.getJsonAnnexMemberAccess().getKeyAssignment_0(), "rule__JsonAnnexMember__KeyAssignment_0");
					put(grammarAccess.getJsonAnnexMemberAccess().getJsonAnnexElementAssignment_2(), "rule__JsonAnnexMember__JsonAnnexElementAssignment_2");
					put(grammarAccess.getJsonAnnexStringAccess().getValueAssignment_1(), "rule__JsonAnnexString__ValueAssignment_1");
					put(grammarAccess.getJsonAnnexNumberAccess().getValueAssignment_0_1(), "rule__JsonAnnexNumber__ValueAssignment_0_1");
					put(grammarAccess.getJsonAnnexNumberAccess().getValueAssignment_1_1(), "rule__JsonAnnexNumber__ValueAssignment_1_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			com.collins.trustedsystems.briefcase.json.ui.contentassist.antlr.internal.InternalJsonParser typedParser = (com.collins.trustedsystems.briefcase.json.ui.contentassist.antlr.internal.InternalJsonParser) parser;
